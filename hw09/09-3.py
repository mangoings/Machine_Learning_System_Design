...
GRU_model = Sequential([
    GRU(units=n_units, return_sequences=False, input_shape=(seq_length-1, 1)),
    Dense(1)
])

GRU_model.compile(optimizer='adam', loss='mse')

history = GRU_model.fit(X_train, y_train, epochs=epochs, validation_data=(X_test, y_test), verbose=0)
